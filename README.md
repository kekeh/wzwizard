...
* include the **wzwizard-0.0.3.min.js** and the **wzwizard-0.0.3.min.css** files into your project. See the **Build project** and the **Installation** chapters below.
```html
<script src="wzwizard-0.0.3.min.js"></script>
<link href="wzwizard-0.0.3.min.css" rel="stylesheet" type="text/css">
```
